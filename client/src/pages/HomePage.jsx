...
const ReferencesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <Navbar showMainNavbar={false} />

      {/* Centered References Section */}
      <section className="flex-1 flex flex-col justify-center items-center text-center mt-20 px-4 md:px-8 lg:px-12">
        {/* Remove max-width to make it wider */}
        <div className="w-full">
          <h2 className="text-[6vh] font-bold mb-12">
